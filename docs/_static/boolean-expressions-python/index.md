...
- [A Simple Boolean Example in Python](#htoc-a-simple-boolean-example-in-python)
- [Boolean Constants and Expressions in Python](#htoc-boolean-constants-and-expressions-in-python)
- [Python Comparison Operators](#htoc-python-comparison-operators)
- [Negation Using Not](#htoc-negation-using-not)
- [If and Else In Python](#htoc-returning-to-our-odd-and-even-example)
- [Handling More Than Two Cases in Python: Elif](#htoc-handling-more-than-two-cases-in-python)
- [Equality Checks and Checking for None](#htoc-equality-checks-and-checking-for-none)
- [What Are Compound Boolean Expressions in Python?](#htoc-what-are-compound-boolean-expressions-in-python)
- [A Truth Table for Python Boolean Expressions](#htoc-a-truth-table-for-python-boolean-expressions)
- [What Are the Precedence Rules For Python Boolean Expressions?](#htoc-what-are-the-precedence-rules-for-python-boolean-expressions)
- [Python If/Else and Booleans: Examples and Practice Questions](#htoc-exerc)
