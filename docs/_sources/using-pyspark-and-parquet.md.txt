...
![Improving the display of PySpark DataFrames by setting the configuration value spark.sql.repl.eagerEval.enabled.](/images/using-pyspark-and-parquet/image-17-1024x166.png)
