...
- [The PathLib Module: Defining the Path Structure](#htoc-the-pathlib-module-defining-the-path-structure)
- [Finding Files in the Current Directory](#htoc-finding-files-in-the-current-directory)
- [Searching for Files Recursively in Python](#htoc-searching-for-files-recursively-in-python)
- [Finding a Single File Recursively](#htoc-finding-a-single-file-recursively)
- [Finding an Absolute Path](#htoc-finding-the-path-to-a-module)
- [Getting the Directory of the Currently Executing File](#htoc-getting-the-directory-of-the-current-running-file)
- [Creating a File In the Same Directory As a Python File](#htoc-creating-a-file-in-the-same-directory-as-a-python-file)
- [Yes, But Does the File Exist?](#htoc-yes-but-does-the-file-exist)
- [Working with Files and Directories](#htoc-working-with-files-and-directories)
    - [Example: Recursively Listing Files and Directories in Python:](#htoc-e)
- [Finding Other Files and Directories](#htoc-getting-the-user-s-home-directory-in-python)
    - [Get the User's Home Directory in Python](#htoc-get-the-user-s-home-directory-in-python)
- [Getting the Current Working Directory](#htoc-getting-the-current-working-directory)
    - [Example: Creating a Directory in the User Home Directory in Python](#htoc-example-creating-a-directory-in-the-user-s-home-directory)
- [Finding Python Module Paths and Files](#htoc-finding-python-module-paths)
    - [Exploring the PYTHONPATH and sys.path Variables](#htoc-exploring-the-pathlib)
- [Finding the Filename from Which a Python Module Was Loaded](#htoc-f)
