...
- [The DateTime Module: Basic Tasks](#htoc-the-datetime-module-basic-tasks)
    - [How to Get the Current Time in Python](#htoc-how-to-get-the-current-time-in-python)
    - [How to Get the Current Date in Python](#htoc-how-to-get-the-current-date-in-python)
- [The Python Datetime Module: A Closer Look](#htoc-the-python-datetime-module-a-closer-look)
- [Aware vs. Naive Datetimes](#htoc-aware-vs-naive-datetimes)
    - [How to Create Time Zone Aware Datetime and Time Instances](#htoc-how-to-create-time-zone-aware-datetime-and-time-instances)
        - [Getting the System Time Zone](#htoc-getting-the-system-time-zone)
        - [Creating an Arbitrary Time Zone: The Zoneinfo Module](#htoc-creating-an-arbitrary-time-zone-the-zoneinfo-module)
- [Getting a Future Date or Past Date in Python](#htoc-getting-a-future-date-or-past-date-in-python-part-i)
    - [Using a Date or Datetime Constructor](#htoc-using-a-date-or-datetime-constructor)
- [Manipulating Dates and Times With Timedelta](#htoc-manipulating-dates-and-times-in-with-timedelta)
    - [How to Add Days to a Date Object In Python](#htoc-how-to-add-days-to-a-date-object-in-python)
    - [Adding or Subtracting Time](#htoc-adding-or-subtracting-time)
    - [Finding the Difference Between Two Dates](#htoc-calculating-a-time-difference)
    - [Calculate Remaining Days Until Christmas in Python](#htoc-calculate-remaining-days-until-christmas-in-python)
- [Formatting and Parsing Dates and Times in Python](#htoc-formatting-and-parsing-dates-and-times-in-python)
    - [Formatting Dates and Times with Strftime](#htoc-formatting-dates-and-times-with-strftime)
    - [Strftime Formatting Codes Review](#htoc-strftime-formatting-codes-review)
    - [Parsing Dates and Times with Strptime](#htoc-parsing-dates-and-times-with-strptime)
- [Saving and Parsing Dates in ISO 8601 Format](#htoc-saving-and-parsing-dates-in-iso-8601-format)
- [Date and Time Related Standard Library Modules](#htoc-date-and-time-related-standard-library-modules)
    - [The Python Calendar Module](#htoc-the-python-calendar-module)
    - [The Python Time Module](#htoc-the-python-time-module)
- [Dateutil: A Python Third-Party DateTime Library](#htoc-dateutil-a-python-third-party-datetime-library)
    - [Dateutil's General Date and Time Parser Class](#htoc-dateutil-s-general-date-and-time-parser-class)
    - [Smart Relative Date/Time Offsets with Dateutil's Relativedelta](#htoc-smart-relative-date-time-offsets-with-dateutil-s-relativedelta)
    - [Handling Recurring Events With Dateutil's Rrule (Recurrence Rule)](#htoc-handling-recurring-events-with-dateutil-s-rrule-recurrence-rule)
