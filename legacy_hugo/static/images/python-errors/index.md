...
- [Syntax Errors in Python](#htoc-syntax-errors-in-python)
    - [Indentation Errors](#htoc-indentation-errors)
- [Exceptions, Errors, and Bugs](#htoc-bugs-exceptions-and-errors)
    - [Exceptions and Errors](#htoc-exceptions-and-errors)
    - [It's Not a Feature; It's a Bug](#htoc-it-s-not-a-feature-it-s-a-bug)
- [Try Block Basics: Handling Exceptions in Python](#htoc-python-exception-handling-basics)
    - [Handling Built-In Exceptions](#htoc-built-in-exceptions)
    - [Handling Base Class Exception Types](#htoc-handling-root-exception-types-or-multiple-exception-types)
    - [Handling Multiple Exception Types](#htoc-handling-multiple-exception-types)
    - [Handling Base Class Exceptions: A Caveat](#htoc-a-note-on-handling-all-exceptions)
- [Raising Built-In and User-Defined Exceptions](#htoc-raising)
- [Python Error Handling: Do's and Don'ts](#htoc-python-error-handling-strategies-and-best-practices)
